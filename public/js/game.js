...
var Game = (() => {
  ...
  canvas[0] = document.getElementById("PlayerCanvas"); // This player
  canvas[1] = document.getElementById("OpponentCanvas"); // Opponent
  ...
  function drawShips(gridIndex) {
    ...
    for (i = 0; i < grid[gridIndex].ships.length; i++) {
      ...
      shipLength =
        squareWidth * ship.size +
        gridBorder * (ship.size - 1) -
        shipPadding * 2;
